...
const agesNew = [22, 14, 24, 55, 65, 21, 12, 13, 90];

const agesFilteredNew = agesNew.filter(function(age){
    return age % 2 === 0  
})
console.log(agesFilteredNew)
...
const streamersLeagueofLegends = streamers.filter(function(game){
...
const streamersWithU = streamersNew.filter(function(name){
